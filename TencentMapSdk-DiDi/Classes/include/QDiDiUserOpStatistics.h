...
extern NSString * const EVENT_START_NAVI;
extern NSString * const EVENT_START_YAW;
extern NSString * const EVENT_RECALCULATE_FINISH;
//埋点上报类
/**
 以下面几个例子来讲解埋点上报接口的使用
 ...
 * @param message 日志消息
 */
+ (void)recordLogWithEvent:(NSString *)eventName message:(NSString *)message;
@end
