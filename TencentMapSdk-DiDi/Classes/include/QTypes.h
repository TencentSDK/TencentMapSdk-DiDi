...
//定义滴滴客户端
typedef NS_ENUM (NSInteger,QMapDidiType)
{
    QMapDidiTypePassenger, //default, 乘客端
    QMapDidiTypeSpecialDriver,//专快司机
    QMapDidiTypeTaxiDriver,//出租车司机
};
